...
2. Clone the repository by using the command
        ...
        git clone https://github.com/sarvesh-adk/Decentralized-Voting-System.git
...
## Code Structure
    ...
    ├── Decentralized-Voting-System       # Root directory of the project.
...
The code in this repository is licensed under the MIT License. This means that you are free to use, modify, and distribute the code, as long as you include the original copyright and license notice. For more information about LICENSE please click [here](https://github.com/sarvesh-adk/Decentralized-Voting-System/blob/main/LICENSE).
